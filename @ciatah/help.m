function obj = help(obj)
	...
	helpText = [ciapkg.pkgName ' help' 10 ...
		'The usually problems are:' 10 ...
		'1) ' ciapkg.pkgName ' is not the current path in MATLAB.' 10 ...
		'2) ' ciapkg.pkgName ' repository is located in a directory that MATLAB cannot write to.' 10 ...
		'3) the folders given to ' ciapkg.pkgName ' do not point to valid folders on the system.' 10 ...
		'4) the regular expressions for TIFF/HDF5/NWB/AVI/etc. movie files are not correct and thus ' ciapkg.pkgName ' cannot find movies in each folder.' 10 ...
