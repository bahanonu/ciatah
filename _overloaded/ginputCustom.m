...
% 2019.11.07 - Modified to make no gap between crosshairs and change color, fix to orange for now. - Biafra
...
for k = 1:4
    crossHair(k) = uicontrol(fig, 'Style', 'text', 'Visible', 'off', 'Units', 'pixels', 'BackgroundColor', [[1 0.5 0.1]], 'HandleVisibility', 'off', 'HitTest', 'off'); %#ok<AGROW>
end
end
