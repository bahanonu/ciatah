function obj = modelAddNewFolders(obj,varargin)
	...
	try
		...
		if isempty(options.folderCellArray)
			newFolderList = inputdlg('One new line per folder path. Enter folder path WITHOUT any single/double quotation marks around the path.','Adding folders to calciumImagingAnalysis object.',[42 150]);
